  ...
  return (
    ...
    >
      <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4">
        ...
        {(loggedInUser && loggedInUser.length > 0) ? <SpeakerDelete /> : null}
      </div>
    </SpeakerProvider>
  );
},
...
function areEqualSpeaker(prevProps, nextProps) {
  return prevProps.speaker.favorite === nextProps.speaker.favorite && prevProps.loggedInUser === nextProps.loggedInUser;
}

export default withAuth(Speaker);
